<?
	...
	list($mysqlStr,$audit) = set_strs($mysqlStr,'chrBack',$info['chrBack'],$audit,$table,$info['ID']);
	list($mysqlStr,$audit) = set_strs($mysqlStr,'chrText',$info['chrText'],$audit,$table,$info['ID']);
