...
function close_colorfind() {
	...
	document.getElementById('preview').style.color = document.getElementById('chrLinkColor').value;
	document.getElementById('preview').style.backgroundColor = document.getElementById('chrBGColor').value;
}
