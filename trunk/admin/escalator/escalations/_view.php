<?
	...
	if($_POST['txtComments'] != '') { db_query("INSERT INTO EscComments SET idEscalation='".$info['ID']."', dtAdded=now(), txtComment='".encode($_POST['txtComments'])."'","Insert Comment"); }
	...
	if(emailer(($info['bManager'] ? $storeinfo2['chrManagerEmail'].', '.$info['chrEmployeeEmail'] : $storeinfo2['chrEmail']),
			...
			$attachments)) {
				...
				$_SESSION['infoMessages'][] = 'Comments Sent and/or Status Saved';
