<?php
/**
 * $Id: ZipFileImpl.php 55 2007-06-20 12:06:34Z spocke $
 *
...
require_once($basepath . "FileManager/Utils/ZipFile.class.php");
...
class Moxiecode_ZipFileImpl extends Moxiecode_BaseFileImpl {
	...
	function &open($mode = 'rb') {
		return new Moxiecode_ZipFileStream($this, $mode);
	}

	// * * Private methods

	function &_getZip() {
		$file =& new ZipFile($this->_zipPath);
