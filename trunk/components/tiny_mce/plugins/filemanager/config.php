<?php
	...
	$mcFileManagerConfig['general.tools'] = "createdir,createdoc,refresh,zip,upload,rename,cut,copy,paste,delete,selectall,unselectall,view,download,insert,addfavorite,removefavorite";
	...
	$mcFileManagerConfig['filesystem.path'] = realpath($BF . 'userfiles/'. $_SESSION['chrEmail']).'/'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = realpath($BF . 'userfiles/'. $_SESSION['chrEmail']).'/'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['log.max_size'] = "500k";
	$mcFileManagerConfig['log.max_files'] = "50";
